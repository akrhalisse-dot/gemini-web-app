...
const TRANSLATIONS = {
  fr: {
    ...
    portfolio: { label: "Sélection de Projets", view_project: "VOIR LE PROJET", view_all: "Voir tout le portfolio" },
  ...
  en: {
    ...
    portfolio: { label: "Selected Projects", view_project: "VIEW PROJECT", view_all: "View full portfolio" },
  ...
  ar: {
    ...
    portfolio: { label: "مختارات من المشاريع", view_project: "عرض المشروع", view_all: "عرض المحفظة الكاملة" },
               ...
               <Reveal delay={100}>
                 <div className="flex items-start gap-6 group">
                   ...
                   <div>
                     ...
                     <p className="font-sans text-xl text-white">18 Impasse sarturan<br/>13005 Marseille</p>
                   </div>
                 </div>
               </Reveal>
               <Reveal delay={200}>
